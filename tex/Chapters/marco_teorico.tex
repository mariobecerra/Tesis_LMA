...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{log_reg_example_1.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{log_reg_example_1_GD_iter.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{lin_reg_example_1_SGD_iter_all.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{lin_reg_example_1_SGD_each_epoch.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{log_reg_example_1_SGD_iter_all.pdf}
  \caption{Iteraciones del algoritmo de descenso en gradiente para regresión logística.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{log_reg_example_1_SGD_each_epoch.pdf}
