...
\begin{figure}
	\centering
 	\includegraphics[width=0.8\textwidth]{frecuencia_calificaciones_MovieLens.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=0.8\textwidth]{calificacion_promedio_articulo_MovieLens.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=0.8\textwidth]{frecuencia_calificaciones_BookCrossing.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=0.8\textwidth]{calificacion_promedio_articulo_BookCrossing.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=0.8\textwidth]{modelo_base_MovieLens.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=\textwidth]{errores_ent_validacion_factorizacion_MovieLens.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=\textwidth]{error_por_iteracion_modelo_fact_MovieLens.pdf}
...
Un sistema de recomendación, además de ser evaluado con el RMSE, también se puede evaluar como un problema de clasificación en el cual se mide qué tan certero es en la tarea de recomendar $N$ artículos a cada usuario.

\begin{figure}
	\centering
 	\includegraphics[width=\textwidth]{recall_base_fact_MovieLens.pdf}
...
\begin{figure}
	\centering
 	\includegraphics[width=\textwidth]{precision_base_fact_MovieLens.pdf}
